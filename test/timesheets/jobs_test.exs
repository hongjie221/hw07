defmodule Timesheets.JobsTest do
  ...
  describe "jobs" do
    ...
    @valid_attrs %{budget: 42, description: "some description", jobcode: "some jobcode"}
    @update_attrs %{budget: 43, description: "some updated description", jobcode: "some updated jobcode"}
    @invalid_attrs %{budget: nil, description: nil, jobcode: nil}
